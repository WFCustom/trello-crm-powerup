...
(function (global) {
  ...
  /* Peer sign-off applies to the shop build and the finish. "Assemble" was one
     column when this was written and is now three, one per job type -- listing
     all three keeps every assemble route covered instead of silently exempting
     CNC and CAP work from QC. */
